...
AutoDestructChecker = function(condition,doOnCondition,doWhileCondition){
    ...
    function(t){
      return function(){
        if(t.condition()){
          ...
          if(typeof t.doWhileCondition == "function" ) t.doWhileCondition();
        }
      }
  }(this),50)
}
...
function requestFullScreen() {
  ...
  window.FULLSCREEN = (FULLSCREEN) ? false : true;
}
